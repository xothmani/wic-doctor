...
// --> General settings
$hesk_settings['site_title']='WIC-DOCTOR';
$hesk_settings['site_url']='https://doctor.way-interactive-convergence.com';
$hesk_settings['hesk_title']='Help Desk';
$hesk_settings['hesk_url']='https://doctor.way-interactive-convergence.com/helpdesk';
$hesk_settings['webmaster_mail']='support.lv1@way-interactive-convergence.com';
$hesk_settings['site_theme']='hesk3';
$hesk_settings['admin_css']=0;
$hesk_settings['admin_css_url']='https://doctor.way-interactive-convergence.com/hesk-style.css';

// --> Language settings
$hesk_settings['can_sel_lang']=0;
$hesk_settings['language']='Français';
$hesk_settings['languages']=array(
'العربية' => array('folder'=>'ar','hr'=>'------ Reply above this line ------'),
'Français' => array('folder'=>'fr','hr'=>'------ Répondre au-dessus de cette ligne ------'),
'English' => array('folder'=>'en','hr'=>'------ Reply above this line ------'),
'Nederlands' => array('folder'=>'nl','hr'=>'------ Reageer boven deze lijn ------'),
'Italiano' => array('folder'=>'it','hr'=>'------ Rispondi sopra questa riga ------'),
...
$hesk_settings['db_pass']='P@ssw0rd1982';
...
$hesk_settings['question_ask']='Which of these is not an animal: monkey, horse, ball';
...
$hesk_settings['url_key']='fpXzUGh2qRH6WGnh7Mf8E05jr7V5Hu';
