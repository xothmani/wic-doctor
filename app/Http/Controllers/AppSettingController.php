...
//                }
    ...
    public function checkForUpdates(Request $request): \Illuminate\Foundation\Application|Redirector|RedirectResponse|Application
    {
        if (!config('installer.demo_app')) {
            Artisan::call('config:clear');
    ...
    public function index($type = null, $tab = null): mixed
    {
        if (empty($type)) {
