 ...
 * Last modified: 2024.04.05 at 16:56:32
...
class ModulesServiceProvider extends ServiceProvider
{
     ...
     */
    private function isInstalledMacro(): void
    {
     ...
     */
    private static function getNewMigrations(string $id, $version = null): array|bool|string
    {
        if (empty($version)) {
     ...
     */
    private function isUpdatedMacro(): void
    {
     ...
     */
    private function isActivatedMacro(): void
    {
