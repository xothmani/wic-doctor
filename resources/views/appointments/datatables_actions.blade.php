<div class='btn-group btn-group-sm'>
    @can('appointments.show')
        <a data-toggle="tooltip" title="{{trans('lang.view_details')}}" href="{{ route('appointments.show', $id) }}" class='btn btn-link'>
            <i class="fas fa-eye"></i> </a> @endcan

    @can('appointments.edit')
        <a data-toggle="tooltip" title="{{trans('lang.appointment_edit')}}" href="{{ route('appointments.edit', $id) }}" class='btn btn-link'>
