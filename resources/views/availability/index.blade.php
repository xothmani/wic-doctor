    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="scheduleTabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="availability-tab" data-toggle="tab" onclick="window.location.href='/availability';" href="#availability" role="tab" aria-controls="availability" aria-selected="true">{{ trans("lang.availability") }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="breaks-tab" data-toggle="tab" href="#breaks" role="tab" aria-controls="breaks" aria-selected="false">{{ trans("lang.breaks") }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="holidays-tab" data-toggle="tab" href="#holidays" role="tab" aria-controls="holidays" aria-selected="false">{{ trans("lang.holidays") }}</a>
                </li>
                <li class="nav-item">
    <a class="nav-link" id="teleconsultations-tab" onclick="window.location.href='/availability-tele';">{{ trans("lang.teleconsultations") }}</a>
</li>
...
<div class="tab-content" id="scheduleTabsContent">
    ...
    <div class="tab-pane fade" id="breaks" role="tabpanel" aria-labelledby="breaks-tab">
                        <form action="{{ route('urgency.store') }}" method="POST">
                            ...
                            <button type="button" onclick="window.location='{{ route('urgency.index') }}'" class="btn btn-default mt-4">
                {{ trans("lang.listUrgence") }}
            </button>
                            <button type="submit" class="btn bg-{{setting('theme_color')}} mt-4">{{ trans("lang.saveBreaks") }}</button>
    ...
    <div class="tab-pane fade" id="holidays" role="tabpanel" aria-labelledby="holidays-tab">
        ...
        <div class="col-md-6" id="fin" style="display: none;">
            ...
            <button type="button" onclick="window.location='{{ route('vacance.index') }}'" class="btn btn-default mt-4">
                {{ trans("lang.listVacance") }}
            </button>
            <button type="submit" class="btn bg-{{setting('theme_color')}} mt-4">{{trans("lang.saveHolidays") }}</button>
        </form>
    </div>
