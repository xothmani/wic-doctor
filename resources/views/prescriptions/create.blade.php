...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-bold">{{trans('lang.prescription_plural') }}<small class="mx-3">|</small><small>{{trans('lang.prescription_desc')}}</small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                  <!--   @can('consultations.index')
                    ...
                    @endcan -->
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.prescription_create')}}</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
