            ...
            <div class="row">
                <div class="col-lg-2 col-4">
                    ...
                    <div class="small-box bg-white shadow-sm">
                        <div class="inner">
                            <h3 class="text-{{setting('theme_color','primary')}}">{{$appointmentsCount}}</h3>
                ...
                <div class="col-lg-2 col-4">
                    ...
                    <div class="small-box bg-white shadow-sm">
                        <div class="inner">
                            <h3 class="text-{{setting('theme_color','primary')}}">{{$clinicsCount}}</h3>
                ...
                <div class="col-lg-2 col-4">
                    ...
                    <div class="small-box bg-white shadow-sm">
                        <div class="inner">
                            ...
                            <p>{{trans('pharmacies::lang.dashboard_total_orders')}}</p>
                        </div>
                        <div class="icon">
                            <i class="fas fa-shopping-bag"></i>
                        </div>
                        <a href="{{route('orders.index')}}" class="small-box-footer">{{trans('pharmacies::lang.dashboard_more_info')}}
                            <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-2 col-4">
                    ...
                    <div class="small-box bg-white shadow-sm">
                        <div class="inner">
                            <h3 class="text-{{setting('theme_color','primary')}}">{{$pharmaciesEarning}}</h3>

                            <p>{{trans('pharmacies::lang.dashboard_pharmacies_earnings')}}</p>
                        </div>
                        <div class="icon">
                            <i class="fas fa-hand-holding-usd"></i>
                        </div>
                        <a href="{!! route('pharmaciesEarnings.index') !!}" class="small-box-footer">{{trans('lang.dashboard_more_info')}}
                            <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-4">
                    ...
                    <div class="small-box bg-white shadow-sm">
                        <div class="inner">
                            <h3 class="text-{{setting('theme_color','primary')}}">{{$pharmaciesCount}}</h3>

                            <p>{{trans('pharmacies::lang.dashboard_total_pharmacies')}}</p>
                        </div>
                        <div class="icon">
                            <i class="fas fa-first-aid"></i>
                        </div>
                        <a href="{!! route('pharmacies.index') !!}" class="small-box-footer">{{trans('pharmacies::lang.dashboard_more_info')}}
                            <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
