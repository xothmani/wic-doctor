...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (userSearch) {
        userSearch.addEventListener('input', function() {
            ...
            noResultsMessage.style.display = hasResults ? 'none !important' : 'block !important';
    ...
    function resetModal() {
        ...
        document.querySelectorAll('.modal-user-item').forEach(item => {
            ...
            item.querySelector('.select-indicator').style.display = 'none !important';
            item.querySelector('.assigned-indicator').style.display = 'none !important';
                ...
                if (currentFileId === '{{ $file->id }}') {
                    ...
                    assignedUsers.forEach(userId => {
                        ...
                        if (userItem) {
                            ...
                            userItem.querySelector('.assigned-indicator').style.display = 'block !important';
                        }
                    });
                }
            @endforeach
    ...
    window.selectUser = function(element) {
        ...
        element.querySelector('.select-indicator').style.display = 'block !important';
