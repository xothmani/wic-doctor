...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-bold">{{ trans('lang.profil') }} <small class="mx-3">|</small><small>{{ trans('lang.edit_profil') }}</small></h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <!-- *************************GESTION ADRESSE -->
                    ...
                    <button class="btn bg-{{setting('theme_color')}} w-100 text-left mt-3 d-flex justify-content-between align-items-center" type="button" data-toggle="collapse" data-target="#adresseSection" aria-expanded="false" aria-controls="adresseSection">
                        <span class="d-flex align-items-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group d-flex align-items-center">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::select('pays', ['' => 'Sélectionnez un pays'] + ['tunisie' => 'Tunisie', 'france' => 'France'], 
                                                isset($address->pays) ? json_decode($address->pays)->fr : null, ['class' => 'form-control', 'id' => 'pays']) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group d-flex align-items-center">
                                        ...
                                        <div class="col-md-9">
                                        {!! Form::select('ville', ['' => 'Sélectionnez une ville'], 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group d-flex align-items-center">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::select('gouvernorat', ['' => 'Sélectionnez un gouvernorat'], 
            ...
            @if(session('success'))
                ...
                @endif
                    ...
                    <button class="btn bg-{{setting('theme_color')}} w-100 text-left mt-3 d-flex justify-content-between align-items-center" type="button" data-toggle="collapse" data-target="#curriculumVitae" aria-expanded="false" aria-controls="curriculumVitae" id="toggleButton">
                        <span class="d-flex align-items-center">
                  ...
                  <div class="col-md-6">
                        <div class="form-group d-flex align-items-center">
                            ...
                            <div class="col-md-9">
                                ...
                                <!-- Add Icon -->
                                <a data-toggle="tooltip" data-placement="left" title="Ajouter un diplôme" href="#" onclick="addDiplome()" class="btn btn-link p-1">
            ...
            <!-- *************************GESTION PHOTOS, VIDÉOS -->
                ...
                <!-- Bouton pour afficher/masquer les champs Photo Cabinet, Images et Vidéos -->
                <button class="btn bg-{{setting('theme_color')}} w-100 text-left mt-3 d-flex justify-content-between align-items-center" type="button" data-toggle="collapse" data-target="#mediaSection" aria-expanded="false" aria-controls="mediaSection" id="toggleButton">
                    <span class="d-flex align-items-center">
                        <i class="fas fa-camera mr-2"></i> Photos Cabinet et Vidéos
                    </span>
                    <i class="fas fa-angle-down fa-lg" id="arrowIcon"></i>
                </button>

                <!-- Conteneur des champs Photo Cabinet, Images et Vidéos -->
                <div class="collapse mt-3" id="mediaSection">
                    <div class="row">
                        <!-- Photo Cabinet -->
                        <div class="col-md-6">
                            <div class="form-group d-flex align-items-center">
                            {!! Form::label('photo_cabinet', 'Photo Cabinet', ['class' => 'col-md-3 control-label text-md-right']) !!}
                            <div class="col-md-9">
                                    {!! Form::file('images[]', ['class' => 'form-control', 'multiple' => 'multiple']) !!}
                                    <small class="form-text text-muted">Sélectionnez plusieurs images à télécharger(vous pouvez en sélectionner plusieurs).</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group d-flex align-items-center">
                                {!! Form::label('videos', 'Vidéos', ['class' => 'col-md-3 control-label text-md-right']) !!}
                                <div class="col-md-9">
                                    {!! Form::file('videos[]', ['class' => 'form-control', 'multiple' => 'multiple']) !!}
                                    <small class="form-text text-muted">Sélectionnez des vidéos à télécharger (vous pouvez en sélectionner plusieurs).</small>
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- Bouton Enregistrer dans la section Photo Cabinet, Images et Vidéos -->
                    <div class="text-right mt-3">
                        {!! Form::submit('Enregistrer', ['class' => 'btn bg-' . setting('theme_color') . ' px-4']) !!}
                    </div>
                </div>
