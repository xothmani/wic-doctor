...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-bold">{{ trans('lang.my_tag_plural') }} 
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb bg-white float-sm-right rounded-pill px-4 py-2 d-none d-md-flex">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{!! route('doctor_requests.index') !!}">{{ trans('lang.my_tag_plural') }}</a>
                        </li>
                        <li class="breadcrumb-item active">{{ trans('lang.tag_desc') }}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
   ...
   <div class="content">
        @include('doctor_tag.card') <!-- Inclus la carte agenda -->
    </div>
    </div>
