        ...
        <div class="row mb-2">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb bg-white float-sm-right rounded-pill px-4 py-2 d-none d-md-flex">
                    ...
                    <li class="breadcrumb-item active">{{trans('lang.telesecretariat_table')}}</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="content">
    ...
    <div class="card shadow-sm">
                ...
                <div class="d-flex flex-row">
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! url()->current() !!}">
                            <i class="fa fa-list mr-2"></i>{{trans('lang.telesecretariat_table')}}
                        </a>
                    </li>
                    @can('telesecretariats.create')
                    <li class="nav-item">
                        <a class="nav-link" href="{!! route('telesecretariats.create') !!}">
                            <i class="fa fa-plus mr-2"></i>{{trans('lang.telesecretariat_create')}}
                        </a>
                    </li>
                    @endcan
                </div>
        ...
        <div class="card-body">
            @include('telesecretariats.table')
            <div class="clearfix"></div>
        </div>
    </div>
</div>
