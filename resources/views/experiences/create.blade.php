                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb bg-white float-sm-right rounded-pill px-4 py-2 d-none d-md-flex">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{!! route('experiences.index') !!}">{{trans('lang.experience_plural')}}</a>
                            </li>
                ...
                <div class="card-header">
                    <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                        @if(auth()->user()->hasPermissionInContext('experiences.index', $doctorId))
                            <li class="nav-item">
                                <a class="nav-link" href="{!! route('experiences.index') !!}"><i
                                        class="fa fa-list mr-2"></i>{{trans('lang.experience_table')}}</a>
                            </li>
                        @endif
                        <li class="nav-item">
                            <a class="nav-link active" href="{!! url()->current() !!}"><i
                                    class="fa fa-plus mr-2"></i>{{trans('lang.experience_create')}}</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
