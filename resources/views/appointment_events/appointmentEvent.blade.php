...
<div class="modal fade" id="appointmentDetailsModal" tabindex="-1" role="dialog" aria-labelledby="appointmentDetailsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary d-none"  id="createTeleconsultation"style="background-color: #AEC6CF; color: #000;">{{ trans('lang.create_teleconsultation') }}</button>
                <button type="button" class="btn btn-danger" id="markAsFailed" style="background-color: #F4C2C2; color: #000;">{{ trans('lang.mark_failed') }}</button>
                <button type="button" class="btn btn-success" id="markAsDone"style="background-color: #B1E5D6; color: #000;">{{ trans('lang.mark_ready') }}</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="appointmentModal" tabindex="-1" role="dialog" aria-labelledby="appointmentModalLabel" aria-hidden="true">
    ...
    <label for="patientDropdown" class="font-weight-bold">{{ trans('lang.Select_Patient') }}</label>
        <div class="d-flex align-items-center">
            <select id="patientDropdown" class="form-control select2-ajax" required style="flex-grow: 1;">
                <option value="" disabled selected>{{ trans('lang.Select_Patient') }}</option>
            </select>
            <a href="{{ route('patients.create') }}" class="btn btn-success d-flex " id="addNewPatient">
                <i class="fa fa-user-plus"></i>
                        ...
                        <div class="form-group" id="dateGroup" >  
                            ...
                            <input type="date" class="form-control" id="appointmentDate" name="appointment_date" readonly>
                        </div>
                    </div>
			    ...
			    <button type="button" id="addMoreAvailable" class="btn btn-primary ml-3"><i class="fas fa-stopwatch"></i></button>
			</div>
		...
		<div class="form-group">
    			<label for="patternDropdown" class="font-weight-bold">
    				...
    				<div class="d-flex align-items-center">
        			<select id="patern_id" name="patern_id" class="form-control select2-ajax" required style="flex-grow: 1;">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="saveAppointmentRef" style="display: none;">{{ trans('lang.save_patient_refer') }}</button>
                        <button type="button" class="btn btn-secondary" id="saveAppointmentPass" style="display: none;">Save Patient de Passage</button>
                    </div>
	                                </form>
            </div>
        </div>
