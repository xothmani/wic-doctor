...
<head>
    ...
    <title>Analyseur d'Images Dentaires</title>
...
<body>
  ...
  <div class="container text-center custom-top-spacing" >
    <h3 class="fw-bold" style="color: var(--primary-color);">
                ...
                Analyseur d'Images Dentaires
    </h3>
    <p class="lead text-muted">Lecture intelligente des radiographies dentaires pour un diagnostic
                        précis.</p>
</div>
            ...
            <div class="col-md-12">
                <div id="upload-section">
                    <form id="upload-form" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header">
                                Type d'Examen Dentaire
                            </div>
                            <div class="card-body">
                                <div class="study-type-selector">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="studyType" id="studyTypePanoramic" value="panoramic" checked>
                                        <label class="form-check-label" for="studyTypePanoramic">Panoramique</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="studyType" id="studyTypeIntraoral" value="intraoral">
                                        <label class="form-check-label" for="studyTypeIntraoral">Intra-oral</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="studyType" id="studyTypeCephalometric" value="cephalometric">
                                        <label class="form-check-label" for="studyTypeCephalometric">Céphalométrique</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="studyType" id="studyTypeCBCT" value="cbct">
                                        <label class="form-check-label" for="studyTypeCBCT">CBCT (Cone Beam)</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="patientTeeth" class="form-label">Zone Dentaire Examinée</label>
                                            <select class="form-select" id="patientTeeth" name="patient_teeth">
                                                <option value="" selected>Sélectionner</option>
                                                ...
                                                <option value="specific">Dent(s) Spécifique(s)</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="patientHistory" class="form-label">Antécédents Dentaires</label>
                                            <select class="form-select" id="patientHistory" name="patient_history">
                                                <option value="" selected>Sélectionner</option>
                                                <option value="no_history">Aucun</option>
                                                <option value="caries">Caries</option>
                                                <option value="periodontitis">Parodontite</option>
                                                <option value="orthodontics">Traitement Orthodontique</option>
                        ...
                        <div class="card" id="cbct-section" style="display: none;">
                            <div class="card-header">
                                Information CBCT
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="cbctScanType" class="form-label">Type de scan CBCT</label>
                                            <select class="form-select" id="cbctScanType" name="cbct_scan_type">
                                                <option value="" selected>Sélectionner</option>
                                                <option value="full">Complet (Full FOV)</option>
                                                <option value="regional">Régional</option>
                                                <option value="dental">Dentaire Spécifique</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="cbctDevice" class="form-label">Appareil CBCT</label>
                                            <select class="form-select" id="cbctDevice" name="cbct_device">
                                                <option value="" selected>Sélectionner</option>
                                                <option value="carestream">Carestream</option>
                                                <option value="planmeca">Planmeca</option>
                                                <option value="vatech">Vatech</option>
                                                <option value="other">Autre</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="upload-area" id="drop-area">
                                    ...
                                    <h5>Glissez-déposez vos images dentaires ici</h5>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select mb-3" id="clinicalIndication" name="clinical_indication">
                                        ...
                                        <option value="pain">Douleur dentaire</option>
                                        <option value="implant">Planification d'implant</option>
                                        <option value="orthodontic">Évaluation orthodontique</option>
                                        <option value="periodontal">Évaluation parodontale</option>
                                        <option value="other">Autre</option>
                                    </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control" id="textInput" name="text_input" rows="3" placeholder="Exemple : Patient de 35 ans avec douleur à la dent 27 depuis 1 semaine..."></textarea>
                    ...
                    <div class="loading text-center mt-4" id="loading">
                        ...
                        <h5>Analyse des images dentaires</h5>
                ...
                <div id="results-section" class="mt-4">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            Résultats de l'Analyse Dentaire
                        ...
                        <div class="card-body" id="content">
                            <div class="row">
                                <div class="col-md-5">
                                    <img id="result-image" src="" alt="Image dentaire" class="result-image">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const cbctSection = document.getElementById('cbct-section');
    const studyTypeRadios = document.querySelectorAll('input[name="studyType"]');
    const MAX_FILES = 6; // Set maximum files limit
    
    // Show CBCT section when study type is CBCT
    for (const radio of studyTypeRadios) {
        radio.addEventListener('change', function() {
            if (this.value === 'cbct') {
                cbctSection.style.display = 'block';
            } else {
                cbctSection.style.display = 'none';
            }
    ...
    function updateUIForStudyType(studyType) {
        ...
        if (studyType === 'panoramic') {
            addOption(clinicalIndication, 'routine', 'Examen de routine');
            addOption(clinicalIndication, 'wisdom_teeth', 'Évaluation des dents de sagesse');
            addOption(clinicalIndication, 'pathology', 'Pathologie dentaire');
            addOption(clinicalIndication, 'trauma', 'Traumatisme');
        } else if (studyType === 'intraoral') {
            addOption(clinicalIndication, 'caries', 'Détection de caries');
            addOption(clinicalIndication, 'periodontal', 'Évaluation parodontale');
            addOption(clinicalIndication, 'restoration', 'Évaluation des restaurations');
        } else if (studyType === 'cephalometric') {
            addOption(clinicalIndication, 'orthodontic', 'Évaluation orthodontique');
            addOption(clinicalIndication, 'skeletal', 'Analyse squelettique');
            addOption(clinicalIndication, 'growth', 'Évaluation de la croissance');
        } else if (studyType === 'cbct') {
            addOption(clinicalIndication, 'implant', 'Planification d’implant');
            addOption(clinicalIndication, 'pathology', 'Pathologie maxillo-faciale');
            addOption(clinicalIndication, 'tmj', 'Évaluation ATM');
            addOption(clinicalIndication, 'sinus', 'Évaluation des sinus');
        }
    ...
    updateUIForStudyType('panoramic');
    ...
    uploadForm.addEventListener('submit', function(e) {
        ...
        formData.append('speciality', 'Dentiste');
    ...
    function displayResults(data) {
        ...
        if (data.file_paths && data.file_paths.length > 0) {
            data.file_paths.forEach((path, index) => {
                const img = document.createElement('img');
                img.src = `${path}`;
                img.alt = `Image dentaire ${index + 1}`;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    saveAnalysisBtn.addEventListener('click', function() {
        ...
        alert('Analyse dentaire enregistrée avec succès !');
    ...
    .then(response => {
      ...
      if (contentType && contentType.includes('application/pdf')) {
        ...
        return response.blob().then(blob => {
          ...
          a.href = url;
          a.download = 'rapport_dentaire.pdf';
...
function getContentDivHtml() {
  ...
  const simplifiedContent = `
    ...
    <body>
      <h1>Rapport d'Analyse Dentaire</h1>
