...
<head>
    ...
    <title>Analyse d'Images Orthopédiques</title>
    ...
    <style>
        :root {
            ...
            --accent-color: #a0dedb;         /* Soft aqua */
            --light-color:rgb(255, 255, 255);          /* Pale mint */
            --dark-color: #005f5f;           /* Deep teal */
        }
...
<body>
    ...
    <h3 class="fw-bold" style="color: var(--primary-color);">
                ...
                Analyse d'Images Orthopédiques
    </h3>
    <p class="lead text-muted">Interprétation d’imageries osseuses et articulaires pour guider les diagnostics.</p>
</div>
            ...
            <div class="col-md-12">
                <div id="upload-section">
                            ...
                            <div class="card-body">
                                <div class="study-type-selector">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="studyTypeCT">Tomodensitométrie</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="patientActivityLevel" class="form-label">Niveau d'Activité</label>
                                            <select class="form-select" id="patientActivityLevel" name="patient_activity_level">
                                                <option value="" selected>Sélectionner</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="patientOrthoHistory" class="form-label">Antécédents Orthopédiques</label>
                                            <select class="form-select" id="patientOrthoHistory" name="patient_ortho_history">
                                                <option value="" selected>Sélectionner</option>
                                                <option value="none">Aucun</option>
                                                <option value="arthritis">Arthrite</option>
                                                <option value="osteoporosis">Ostéoporose</option>
                                                <option value="prior_fracture">Fracture antérieure</option>
                                                <option value="joint_replacement">Remplacement articulaire</option>
                                                <option value="other">Autre</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="upload-area" id="drop-area">
                                    ...
                                    <h5>Glissez et déposez vos images orthopédiques ici</h5>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select mb-3" id="clinicalIndication" name="clinical_indication">
                                        ...
                                        <option value="joint_pain">Douleur articulaire</option>
                                        <option value="trauma">Traumatisme</option>
                                        <option value="arthritis">Arthrite</option>
                                        <option value="deformity">Déformation</option>
                                        <option value="other">Autre</option>
                                    </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control" id="textInput" name="text_input" rows="3" placeholder="Exemple : Patient avec douleur chronique au genou et gonflement..."></textarea>
                    ...
                    <div class="loading text-center mt-4" id="loading">
                        ...
                        <h5>Analyse des images orthopédiques</h5>
                ...
                <div id="results-section" class="mt-4">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            Résultats de l'Analyse Orthopédique
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const BACKEND_URL = 'http://localhost:5007/upload'; // Adjust if backend is hosted elsewhere
            ...
            function updateUIForStudyType(studyType) {
                ...
                if (studyType === 'xray') {
                    ...
                    addOption(clinicalIndication, 'arthritis', 'Arthrite');
                    addOption(clinicalIndication, 'dislocation', 'Luxation');
                    addOption(clinicalIndication, 'bone_density', 'Évaluation de la densité osseuse');
                } else if (studyType === 'ct') {
                    addOption(clinicalIndication, 'complex_fracture', 'Fracture complexe');
                    addOption(clinicalIndication, 'tumor', 'Tumeur osseuse');
                    addOption(clinicalIndication, 'joint_damage', 'Dommage articulaire');
                    addOption(clinicalIndication, 'spinal_injury', 'Blessure spinale');
                } else if (studyType === 'mri') {
                    addOption(clinicalIndication, 'ligament_tear', 'Déchirure ligamentaire');
                    addOption(clinicalIndication, 'cartilage_damage', 'Dommage cartilagineux');
                    addOption(clinicalIndication, 'soft_tissue_injury', 'Blessure des tissus mous');
                    addOption(clinicalIndication, 'spinal_disc', 'Pathologie du disque spinal');
                }
    ...
    uploadForm.addEventListener('submit', function(e) {
        ...
        formData.append('speciality', 'Chirurgien Orthopédiste');
