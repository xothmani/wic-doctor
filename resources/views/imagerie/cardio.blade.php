...
<head>
    ...
    <title>Analyseur d'Images Cardiologiques</title>
    ...
    <style>
        :root {
            ...
            --accent-color: #FECACA; /* Light pink */
            --light-color: #FEF2F2; /* Very light pink */
            --dark-color: #7F1D1D; /* Darker red */
        }
...
<body>
  ...
  <i class="fas fa-heartbeat"></i>                  Analyseur d'Images Cardiologiques
    </h3>
    <p class="lead text-muted">Interprétation automatisée des examens cardiaques pour une évaluation rapide</p>
</div>
        </div>
            ...
            <div class="col-md-12">
                <div id="upload-section">
                    <form id="upload-form" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header">
                                Type d'Examen Cardiologique
                            </div>
                            <div class="card-body">
                                <div class="study-type-selector">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="studyType" id="studyTypeEcho" value="echo" checked>
                                        <label class="form-check-label" for="studyTypeEcho">Échocardiographie</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="studyTypeMRI">IRM cardiaque</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="studyType" id="studyTypeAngio" value="angio">
                                        <label class="form-check-label" for="studyTypeAngio">Angiographie</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="studyType" id="studyTypeStress" value="stress">
                                        <label class="form-check-label" for="studyTypeStress">Test d'effort</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="cardiacCondition" class="form-label">Condition Cardiaque</label>
                                            <select class="form-select" id="cardiacCondition" name="cardiac_condition">
                                                <option value="" selected>Sélectionner</option>
                                                <option value="ischemic">Cardiopathie ischémique</option>
                                                <option value="heart_failure">Insuffisance cardiaque</option>
                                                <option value="arrhythmia">Arythmie</option>
                                                <option value="valvular">Maladie valvulaire</option>
                                                <option value="other">Autre</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="patientStatus" class="form-label">Antécédents cardiologiques</label>
                                            <select class="form-select" id="patientStatus" name="patient_status">
                                                ...
                                                <option value="smoking">Tabagisme</option>
                                                <option value="prior_surgery">Chirurgie cardiaque antérieure</option>
                                                <option value="other">Autre</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="upload-area" id="drop-area">
                                    ...
                                    <h5>Glissez-déposez vos images cardiologiques ici</h5>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select mb-3" id="clinicalIndication" name="clinical_indication">
                                        ...
                                        <option value="heart_failure">Insuffisance cardiaque</option>
                                        <option value="ischemia">Suspicion d'ischémie</option>
                                        <option value="valve_assessment">Évaluation valvulaire</option>
                                        <option value="other">Autre</option>
                                    </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control" id="textInput" name="text_input" rows="3" placeholder="Exemple : Patient de 55 ans avec douleur thoracique atypique, antécédents d'hypertension..."></textarea>
                    ...
                    <div class="loading text-center mt-4" id="loading">
                        ...
                        <h5>Analyse des images cardiologiques</h5>
                ...
                <div id="results-section" class="mt-4">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            Résultats de l'Analyse Cardiologique
                        ...
                        <div class="card-body" id="content">
                            <div class="row">
                                <div class="col-md-5">
                                    <img id="result-image" src="" alt="Image cardiologique" class="result-image">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    uploadForm.addEventListener('submit', function(e) {
        ...
        formData.append('speciality', 'Cardiologue');
    ...
    function displayResults(data) {
        ...
        if (data.file_paths && data.file_paths.length > 0) {
            data.file_paths.forEach((path, index) => {
                const img = document.createElement('img');
                img.src = `${path}`;
                img.alt = `Image Cardiologique ${index + 1}`;
...
document.addEventListener('DOMContentLoaded', function() {
            ...
            saveAnalysisBtn.addEventListener('click', function() {
                ...
                alert('Analyse Cardiologique enregistrée avec succès !');
    ...
    .then(response => {
      ...
      if (contentType && contentType.includes('application/pdf')) {
        ...
        return response.blob().then(blob => {
          ...
          a.href = url;
          a.download = 'rapport_Médical.pdf';
...
function getContentDivHtml() {
  ...
  const simplifiedContent = `
    ...
    <head>
      <meta charset="UTF-8">
      <title>Rapport Cardiologique</title>
      <style>
    ...
    <body>
      <h1>Rapport d'Analyse Cardiologique</h1>
