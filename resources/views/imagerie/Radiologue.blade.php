...
<head>
    ...
    <title>Radiology Image Analysis</title>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.1.3/css/bootstrap.min.css" rel="stylesheet">
    <style>
        :root {
            --primary-color: #2980b9;
            --secondary-color:rgb(59, 147, 206);
            --accent-color:rgb(148, 184, 207);
            --light-color:rgb(255, 255, 255);
            --dark-color:rgb(4, 72, 128);
        }
       ...
       body {
        ...
        .card {
            border: none;
            border-radius: 10px;
            box-shadow: 0 4px 6px rgba(38, 124, 194, 0.08);
            margin-bottom: 20px;
            overflow: hidden;
        }
...
<body>
    ...
    <p class="lead text-muted">Analyse automatique et intelligente de tous vos types d’images médicales : IRM, scanner, rayons X, échographies.</p>
</div>
            ...
            <div class="col-md-12">
                <div id="upload-section">
                    <form id="upload-form" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header">
                                Type d'Étude Radiologique
                            </div>
                            <div class="card-body">
                                <div class="study-type-selector">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="studyType" id="studyTypeXRay" value="xray" checked>
                                        <label class="form-check-label" for="studyTypeXRay">Radiographie</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="studyType" id="studyTypeCT" value="ct">
                                        <label class="form-check-label" for="studyTypeCT">Tomodensitométrie (TDM)</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="patientStatus" class="form-label">Antécédents Médicaux</label>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="upload-area" id="drop-area">
                                    ...
                                    <h5>Glissez et déposez vos images radiologiques ici</h5>
                                    <p class="text-muted">ou</p>
                                    <input type="file" id="fileInput" class="custom-file-input" name="files[]" multiple accept="image/jpeg,image/png,image/dicom">
                                    <label for="fileInput" class="file-input-label">
                                        <i class="fas fa-images"></i>
                                        Sélectionner des Images
                                    </label>
                                    <p class="mt-3 text-muted small">Formats pris en charge : JPG, PNG, DICOM (max 10 Mo par fichier)</p>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select mb-3" id="clinicalIndication" name="clinical_indication">
                                        ...
                                        <option value="bleeding">Hémorragie</option>
                                        <option value="other">Autre</option>
                                    </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control" id="textInput" name="text_input" rows="3" placeholder="Exemple : Patient de 55 ans avec douleur thoracique aiguë..."></textarea>
                                            <button class="btn btn-outline-secondary" type="button" id="voiceInputBtn" title="Entrée Vocale">
                                                <i class="fas fa-microphone"></i>
                                            </button>
                                        </div>
                                        <div class="mt-2">
                                            <span id="recordingStatus" class="text-muted" style="display: none;">Enregistrement...</span>
                                            <div id="voice-error" class="error-message"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="loading text-center mt-4" id="loading">
                        ...
                        <h5>Analyse des images radiologiques</h5>
                        <p class="text-muted">Cela peut prendre un moment...</p>
                    </div>
                </div>
                ...
                <div id="results-section" class="mt-4">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            Résultats de l'Analyse Radiologique
                                ...
                                <div class="col-md-7">
                                    <div class="analysis-section">
                                        ...
                                        <div class="findings-list">
                                            <h5><i class="fas fa-list me-2"></i>Constatations</h5>
                                            <ul id="findings" class="editable-section list-group" contenteditable="false">
                                                <li class="list-group-item">Constatation 1</li>
                                            </ul>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-4">
                        ...
                        <button class="btn btn-outline-secondary btn-lg px-4" id="new-analysis-btn">
                            <i class="fas fa-redo me-2"></i>Analyser de Nouvelles Images
                        </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const ALLOWED_TYPES = ['image/jpeg', 'image/png', 'application/dcm'];
            const BACKEND_URL = 'https://wicdialer.com/speciality/upload'; // Adjust if backend is hosted elsewhere
            ...
            function updateUIForStudyType(studyType) {
                ...
                if (studyType === 'xray') {
                    addOption(clinicalIndication, 'chest_pain', 'Douleur thoracique');
                    addOption(clinicalIndication, 'fracture', 'Fracture');
                    addOption(clinicalIndication, 'infection', 'Infection');
                    addOption(clinicalIndication, 'lung_disease', 'Maladie pulmonaire');
                } else if (studyType === 'ct') {
                    addOption(clinicalIndication, 'trauma', 'Traumatisme');
                    addOption(clinicalIndication, 'tumor', 'Tumeur');
                    addOption(clinicalIndication, 'bleeding', 'Hémorragie');
                    addOption(clinicalIndication, 'vascular', 'Maladie vasculaire');
                } else if (studyType === 'mri') {
                    addOption(clinicalIndication, 'neurological', 'Symptômes neurologiques');
                    addOption(clinicalIndication, 'joint_pain', 'Douleur articulaire');
                    addOption(clinicalIndication, 'soft_tissue', 'Lésion des tissus mous');
                    addOption(clinicalIndication, 'tumor', 'Tumeur');
                } else if (studyType === 'ultrasound') {
                    addOption(clinicalIndication, 'abdominal_pain', 'Douleur abdominale');
                    addOption(clinicalIndication, 'pregnancy', 'Grossesse');
                    addOption(clinicalIndication, 'vascular', 'Évaluation vasculaire');
                    addOption(clinicalIndication, 'organ_evaluation', 'Évaluation des organes');
                }
    ...
    // In the handleFiles function, update the file type check
    function handleFiles(files) {
        preview.innerHTML = '';
        selectedFiles = Array.from(files);

        selectedFiles.forEach((file, index) => {
            // Allow files with .dcm or .dicom extension or matching MIME type
            ...
            if (isValidType) {
                ...
                reader.onload = function(e) {
                    ...
                    // For DICOM files, display a placeholder or skip image preview
                    let img;
                    if (file.type === 'application/dicom' || file.name.toLowerCase().endsWith('.dcm') || file.name.toLowerCase().endsWith('.dicom')) {
                        img = document.createElement('div');
                        img.textContent = 'DICOM File: ' + file.name;
                ...
                // Read as data URL only for image files
                if (file.type.startsWith('image/')) {
                    reader.readAsDataURL(file);
                } else {
                    // For DICOM, trigger onload without reading (to show placeholder)
                    reader.onload({ target: { result: '' } });
                }
            } else {
                alert(`File ${file.name} is not supported. Please upload JPEG, PNG, or DICOM files.`);
            }
        });
    }
    ...
    uploadForm.addEventListener('submit', function(e) {
        ...
        formData.append('speciality', 'Radiologue');
