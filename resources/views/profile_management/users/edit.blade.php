...
@section('settings_title', trans('lang.edit_user'))
@section('content')
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2 align-items-center">
            <div class="col-sm-6">
                <h1 class="m-0 text-bold">{{ trans('lang.doctor_user_table') }}
                    <small class="mx-3">|</small>
                    <small>{{ trans('lang.edit_user_desc') }}</small>
                </h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb bg-white float-sm-right rounded-pill px-3 py-1">
                    ...
                    <li class="breadcrumb-item active">{{ trans('lang.edit_user') }}</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="card shadow-sm">
        ...
        <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="{!! url()->current() !!}">
                    <i class="fas fa-edit mr-2"></i>{{ trans('lang.edit_user') }}
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="card-body">
        {!! Form::model($user, ['route' => ['Doctors_users.update', $user->id], 'method' => 'patch']) !!}
        <div class="row">
            ...
            <div class="form-group col-6">
                ...
                {!! Form::date('start_date', $profileManagement->start_date, ['class' => 'form-control']) !!}
            </div>

            <!-- End Date Field -->
            <div class="form-group col-6">
                {!! Form::label('end_date', trans("lang.end_date"), ['class' => 'control-label']) !!}
                {!! Form::date('end_date', $profileManagement->end_date, ['class' => 'form-control']) !!}
            </div>
