    ...
    <li class="nav-item has-treeview {{ Request::is('doctors*') || Request::is('doctorReviews*')|| Request::is('availabilityHours*')|| Request::is('experiences*') ? 'menu-open' : '' }}">
        ...
        <ul class="nav nav-treeview">
            ...
            @can('appointment-events.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('appointment-event*') ? 'active' : '' }}" href="{!! route('appointment-event.index') !!}">
                        @if($icons)
            ...
            @can('availabilityHours.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('availabilityHours*') ? 'active' : '' }}" href="{!! route('availability.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-business-time"></i>@endif<p>{{trans('lang.availability_hour_plural')}}</p></a>
                </li>
            @endcan
	   @can('patterns.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('patterns*') ? 'active' : '' }}" href="{!! route('patterns.index') !!}">@if($icons)
...
@can('appointments.today.completed')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('appointments/today/completed*') ? 'active' : '' }}" href="{!! route('appointments.today.completed') !!}">
            @if($icons)
...
@can('teleconsultation.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('teleconsultations*') ? 'active' : '' }}" href="{!! route('teleconsultations.index') !!}">
            @if($icons)
...
@endcan
    ...
    <li class="nav-header">{{trans('lang.pharmacy_plural')}}</li>
        <li class="nav-item has-treeview {{ Request::is('pharmacies/pharmacies*') || Request::is('pharmacies/pharmacyTypes*') || Request::is('pharmacies/availabilityHourPharmacies*')? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ Request::is('pharmacies/pharmacies*') || Request::is('pharmacies/pharmacyTypes*') || Request::is('pharmacies/availabilityHourPharmacies*')? 'active' : '' }}"> @if($icons)<i class="nav-icon fas fa-first-aid"></i>@endif
                <p>{{trans('lang.pharmacy_plural')}}<i class="right fas fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
                @can('pharmacies.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('pharmacies/pharmacies*') ? 'active' : '' }}" href="{!! route('pharmacies.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-first-aid"></i>@endif<p>{{trans('lang.pharmacy_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
                </li>
                @endcan
                @can('pharmacyTypes.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('pharmacies/pharmacyTypes*') ? 'active' : '' }}" href="{!! route('pharmacyTypes.index') !!}">@if($icons)
                                <i class="nav-icon fas fa-first-aid"></i>@endif<p>{{trans('lang.pharmacy_type_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
                    </li>
                @endcan
                @can('availabilityHourPharmacies.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('pharmacies/availabilityHourPharmacies*') ? 'active' : '' }}" href="{!! route('availabilityHourPharmacies.index') !!}">@if($icons)
                                <i class="nav-icon far fa-clock"></i>@endif<p>{{trans('pharmacies::lang.availability_hour_pharmacy_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
                    </li>
                @endcan
                    @can('pharmaciesEarnings.index')
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('pharmacies/pharmaciesEarnings*') ? 'active' : '' }}" href="{!! route('pharmaciesEarnings.index') !!}">@if($icons)
                                    <i class="nav-icon fas fa-money-bill"></i>@endif<p>{{trans('pharmacies::lang.pharmacy_earning_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
                        </li>
                    @endcan
            </ul>
        </li>
...
@if(Module::isActivated('Subscription'))
    ...
    @can('subscriptionPackages.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('subscription/subscriptionPackages*') ? 'active' : '' }}" href="{!! route('subscriptionPackages.index') !!}">@if($icons)
                    <i class="nav-icon fa fa-th-list"></i>@endif
                <p>{{trans('subscription::lang.subscription_package_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
        </li>
    @endcan

    @can('clinicSubscriptions.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('subscription/clinicSubscriptions*') ? 'active' : '' }}" href="{!! route('clinicSubscriptions.index') !!}">@if($icons)
...
@if(Module::isActivated('Pharmacies'))
        ...
        <li class="nav-item has-treeview {{ Request::is('pharmacies/pharmacies*') || Request::is('pharmacies/pharmacyTypes*') || Request::is('pharmacies/availabilityHourPharmacies*')? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview">
                ...
                @can('pharmacyTypes.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('pharmacies/pharmacyTypes*') ? 'active' : '' }}" href="{!! route('pharmacyTypes.index') !!}">@if($icons)
                                <i class="nav-icon fas fa-first-aid"></i>@endif<p>{{trans('pharmacies::lang.pharmacy_type_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
                    </li>
                @endcan
                @can('availabilityHourPharmacies.index')
                    <li class="nav-item">
    ...
    @endcan
    @can('medicines.index')
        <li class="nav-item has-treeview {{ Request::is('pharmacies/medicines*') || Request::is('pharmacies/forms*') || Request::is('pharmacies/medicineOptionGroups*') || Request::is('pharmacies/medicineOptions*') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ Request::is('pharmacies/medicines*') || Request::is('pharmacies/forms*') || Request::is('pharmacies/medicineOptionGroups*') || Request::is('pharmacies/medicineOptions*') ? 'active' : '' }}"> @if($icons)<i class="nav-icon fas fa-capsules"></i>@endif
                <p>{{trans('pharmacies::lang.medicine_plural')}}<i class="right fas fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
                @can('medicines.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('pharmacies/medicines*') ? 'active' : '' }}" href="{!! route('medicines.index') !!}">@if($icons)
                ...
                @can('forms.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('pharmacies/forms*') ? 'active' : '' }}" href="{!! route('forms.index') !!}">@if($icons)
                ...
                @can('medicineOptionGroups.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('pharmacies/medicineOptionGroups*') ? 'active' : '' }}" href="{!! route('medicineOptionGroups.index') !!}">@if($icons)
                                <i class="nav-icon fas fa-plus-square"></i>@endif<p>{{trans('pharmacies::lang.medicine_option_group_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
                    </li>
                @endcan
                @can('medicineOptions.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('pharmacies/medicineOptions*') ? 'active' : '' }}" href="{!! route('medicineOptions.index') !!}">@if($icons)
                                <i class="nav-icon far fa-plus-square"></i>@endif<p>{{trans('pharmacies::lang.medicine_option_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
                    </li>
                @endcan
    ...
    @can('categories.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('pharmacies/categories*') ? 'active' : '' }}" href="{!! route('categories.index') !!}">@if($icons)
    ...
    @endcan
    @can('orders.index')
        <li class="nav-item has-treeview {{ Request::is('pharmacies/orders*') || Request::is('pharmacies/orderStatuses*') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ Request::is('pharmacies/orders*') || Request::is('pharmacies/orderStatuses*') ? 'active' : '' }}"> @if($icons)<i class="nav-icon fas fa-shopping-bag"></i>@endif
            ...
            <ul class="nav nav-treeview">
                @can('orders.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('pharmacies/orders*') ? 'active' : '' }}" href="{!! route('orders.index') !!}">@if($icons)
                                <i class="nav-icon fas fa-shopping-bag"></i>@endif<p>{{trans('pharmacies::lang.order_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
                    </li>
                @endcan
                @can('orderStatuses.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('pharmacies/orderStatuses*') ? 'active' : '' }}" href="{!! route('orderStatuses.index') !!}">@if($icons)
                                <i class="nav-icon fa fa-server"></i>@endif<p>{{trans('pharmacies::lang.order_status_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
                    </li>
                @endcan
