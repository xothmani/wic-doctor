...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <!-- Doctor Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('doctors[]', trans("lang.coupon_doctor_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('doctors[]', $doctor, $doctorsSelected, ['class' => 'select2 form-control', 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("lang.coupon_doctor_id_help") }}</div>
        </div>
    </div>

    <!-- Clinic Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('clinic[]', trans("lang.coupon_clinic_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('clinic[]', $clinic, $clinicsSelected, ['class' => 'select2 form-control', 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("lang.coupon_clinic_id_help") }}</div>
        </div>
    </div>

    <!-- Speciality Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('specialities[]', trans("lang.coupon_speciality_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('specialities[]', $speciality, $specialitiesSelected, ['class' => 'select2 form-control', 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("lang.coupon_speciality_id_help") }}</div>
        </div>
    </div>
