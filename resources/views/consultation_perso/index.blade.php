...
@section('content')
    ...
    <div class="wic-icon">
        <i class="fas fa-file-medical"></i> {{-- Icône explicite pour formulaire médical --}}
    </div>
    <div class="wic-title">
        <h2>WIC Consultation Spécialisée</h2>
        <p class="wic-subtitle">Des formulaires médicaux adaptés à chaque spécialité.</p>
    </div>
</div>

                                <div class="wic-description">
                                    <p>Chez WIC Doctor, nous savons que chaque spécialité médicale a ses propres besoins, ses propres outils, et sa propre façon de consulter.
C’est pourquoi nous avons conçu un espace dédié aux consultations personnalisées par spécialité, sous forme de PDF interactifs, prêts à l’emploi.
...
<div class="wic-features">
    <div class="feature-item">
        <a href="https://wic-doctor.com/inscription-professionnel/wic-partage-medical.html" target="_blank" class="feature-link">
            <i class="fas fa-file-medical-alt"></i>  {{-- Icône pour les formulaires structurés --}}
            <span>Standardisé et structuré</span>
        </a>
    </div>
    <div class="feature-item">
        <a href="https://wic-doctor.com/inscription-professionnel/wic-partage-medical.html" target="_blank" class="feature-link">
            <i class="fas fa-stopwatch"></i> {{-- Icône pour la rapidité --}}
            <span>Rapide et ciblé</span>
        </a>
    </div>
    <div class="feature-item">
        <a href="https://wic-doctor.com/inscription-professionnel/wic-partage-medical.html" target="_blank" class="feature-link">
            <i class="fas fa-user-md"></i> {{-- Icône pour la spécialité médicale --}}
            <span>Adapté à votre spécialité</span>
        </a>
    </div>
</div>
                                            ...
                                            <div class="patient-card-body d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="patient-meta mt-2">
                                                        <div class="meta-item">
<i class="fas fa-file-medical"></i>                                                             <span>Consultation Spécialisée</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="patient-card-footer">
                                               <a href="{{ route('consultation_perso.select_pdf', $patient) }}" class="btn-view-files">
    Choisir votre consultation
</a>
...
@push('styles')
    <style>
        :root {
            ...
            --info-gradient: linear-gradient(135deg, #577daa 0%, #577daa 100%);
        ...
        .wic-icon {
            ...
            color: white;
            font-size: 1.5rem;
            box-shadow: 0 8px 25px #a9bed8ff;
        }
