                    ...
                    <div class="modern-chat-area">
                        ...
                        <div id="welcome-screen" class="welcome-screen">
                            <div class="welcome-content">
                                ...
                                <h3 class="welcome-title">Bienvenue dans WIC Messenger</h3>
                                <p class="welcome-text">Sélectionnez une conversation pour commencer à discuter avec vos
                                    collègues et patients</p>
    ...
    <script>
            ...
            try {
                ...
                latestMessages.forEach((latestMessage, otherUserId) => {
                    try {
                        ...
                        console.log('Processing User:', otherUserInfo);
                        ...
                        let avatarText = otherUserInfo.imageUrl || otherUserInfo.avatar || '/images/default-avatar.png';
                        console.log('Avatar Text Before Check:', avatarText);

                        let isTextAvatar = false;
                        if (!avatarText || avatarText === '/images/icons/.png' || avatarText === '/images/default-avatar.png' || avatarText.startsWith('/images/icons/')) {
                            const nameWords = (otherUserInfo.name || `User ${otherUserInfo.id}`).split(' ');
                            avatarText = nameWords.length >= 2 ? `${nameWords[0]} ${nameWords[1]}` : otherUserInfo.name || `User ${otherUserInfo.id}`;
                            isTextAvatar = true;
                        }
                        console.log('Avatar Text After Check:', avatarText);
                        ...
                        const conversationObj = {
                            ...
                            avatar: isTextAvatar ? null : avatarText, // Null if text avatar
                            avatarText: isTextAvatar ? avatarText : null, // Set avatarText for text
                            other_user: {
                                id: otherUserInfo.id,
                                name: otherUserInfo.name || `User ${otherUserInfo.id}`,
                        ...
                        console.log('Added Conversation:', conversationObj);
                    } catch (convError) {
        ...
        function displayFriends(friends) {
            ...
            friends.forEach(friend => {
                html += `
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <div class="friend-item" onclick="startChatWithFriend(${friend.id}, '${friend.name}', '${friend.avatar}')">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <img src="${friend.avatar || '/images/default-avatar.png'}" class="contact-avatar" alt="${friend.name}">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <div class="contact-info">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <h6 class="contact-name">${friend.name}</h6>
        ...
        function startChatWithFriend(friendId, name, avatar) {
        ...
        function loadChatSidebarData() {
            ...
            // Update contact info in sidebar with null checks
            const contactNameElement = document.getElementById('chat-contact-name');
            const contactAvatarElement = document.getElementById('chat-avatar');
            const contactStatusElement = document.getElementById('chat-contact-status');

            const sidebarContactNameElement = document.getElementById('sidebar-contact-name');
            const sidebarAvatarElement = document.getElementById('sidebar-avatar');
            const sidebarContactStatusElement = document.getElementById('sidebar-contact-status');

            // Only update if both source and target elements exist
            if (contactNameElement && sidebarContactNameElement) {
                sidebarContactNameElement.textContent = contactNameElement.textContent;
            }

            if (contactAvatarElement && sidebarAvatarElement) {
                sidebarAvatarElement.src = contactAvatarElement.src;
            }

            if (contactStatusElement && sidebarContactStatusElement) {
                sidebarContactStatusElement.textContent = contactStatusElement.textContent;
            }
        ...
        async function loadSharedMedia() {
            try {
                ...
                if (isGroupConversation) {
                    ...
                    let normalizedId = currentConversationId;
                    if (currentConversationId.includes('-')) {
                    ...
                    // For direct conversations - get all messages first, then filter
                ...
                // Fallback: Show empty state with null checks
                const sharedImagesElement = document.getElementById('shared-images');
                const sharedFilesElement = document.getElementById('shared-files');
                const sharedLinksElement = document.getElementById('shared-links');
                ...
                if (sharedImagesElement) {
                    sharedImagesElement.innerHTML = '<p class="text-muted text-center">Erreur de chargement</p>';
                }
                if (sharedFilesElement) {
                    sharedFilesElement.innerHTML = '<p class="text-muted text-center">Erreur de chargement</p>';
                }
                if (sharedLinksElement) {
                    sharedLinksElement.innerHTML = '<p class="text-muted text-center">Erreur de chargement</p>';
                }

                // Reset counts with null checks
                if (imagesCountElement) imagesCountElement.textContent = '0';
                if (filesCountElement) filesCountElement.textContent = '0';
                if (linksCountElement) linksCountElement.textContent = '0';
            }
        }
        ...
        function displaySharedImages(images) {
            ...
            if (!container || !countElement) {
                console.error('❌ Required elements not found for shared images');
                return;
            }
            ...
            images.forEach((image, index) => {
                html += `
                                                <div class="media-item" onclick="openSharedImagesGrid(${index})">
                                                    <img src="${image.fileUrl}" alt="${image.fileName || 'Image'}">
                                                </div>
                                            `;
            });
        ...
        function displaySharedFiles(files) {
            ...
            // Add null checks
            if (!container || !countElement) {
                console.error('❌ Required elements not found for shared files');
                return;
            }
            ...
            files.forEach((file, index) => {
                html += `
                                                <div class="file-grid-item" onclick="openSharedFilesGrid(${index})">
                                                    ...
                                                    <div class="file-grid-name">${file.fileName || 'Fichier'}</div>
                                                </div>
                                            `;
            });
        ...
        function displaySharedLinks(links) {
            ...
            // Add null checks
            if (!container || !countElement) {
                console.error('❌ Required elements not found for shared links');
                return;
            }
