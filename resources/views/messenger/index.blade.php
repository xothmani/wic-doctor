                    ...
                    <div class="modern-sidebar">
                        ...
                        <div class="user-profile-header">
                            ...
                            <div class="header-actions">
                                <button class="action-btn" onclick="refreshCurrentTab()" title="Actualiser">
                                    <i class="fas fa-sync-alt"></i>
                                </button>
                                <button class="action-btn" onclick="showAddFriendModal()" title="Ajouter un ami">
                                    <i class="fas fa-user-plus"></i>
                                </button>
                                <button class="action-btn" onclick="showSettings()" title="Paramètres">
                            ...
                            <div class="modern-chat-header">
                                <div class="chat-contact-info">
                                    ...
                                    <div class="contact-details">
                                        ...
                                        <span class="contact-status" id="chat-contact-status">En ligne</span>
                                    </div>
                                </div>
                                <div class="chat-actions">
                                    ...
                                    <button class="chat-action-btn" onclick="makePhoneCall()"
                                        title="Appel téléphonique">
                                        <i class="fas fa-phone"></i>
                                    </button>
                                    <button class="chat-action-btn" onclick="showChatInfo()" title="Informations">
                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-section">
                                ...
                                <div class="contact-details-sidebar">
                                    ...
                                    <p class="sidebar-contact-status" id="sidebar-contact-status">En ligne</p>
                                </div>
                            </div>
...
@push('scripts')
    <script>
        ...
        function showAddFriendModal() {
            // Create and show a simple modal for adding friends
            const modalHtml = `
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <div class="modal-content modern-modal">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <div class="modal-body">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <div class="search-user-container">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <label class="form-label">Rechercher par email:</label>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <div class="email-search-wrapper">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <input type="email" class="email-search-input modern-input"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            placeholder="email@exemple.com" id="modalSearchEmail">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <button class="search-user-btn" onclick="searchUserByEmailModal()">
            ...
            patients.forEach(patient => {
                ...
                html += `
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <div class="patient-item" onclick="startChatWithPatient(${patient.id}, '${patientName.replace(/'/g, "\\'")}', '${patient.avatar || '/images/default-avatar.png'}')">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <img src="${patient.avatar || '/images/default-avatar.png'}" class="contact-avatar" alt="${patientName}">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <div class="contact-info">
        ...
        function loadChatSidebarData() {
            ...
            const contactAvatar = document.getElementById('chat-avatar').src;
            const contactStatus = document.getElementById('chat-contact-status').textContent;

            document.getElementById('sidebar-contact-name').textContent = contactName;
            document.getElementById('sidebar-avatar').src = contactAvatar;
...
@push('styles')
    <style>
        ...
        .user-profile-header {
            padding: 20px 24px;
            /* Match other headers for consistent height */
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
            color: white;
            display: flex;
            align-items: center;
