...
echo _gettext("Continue");
    ...
    {
        return new Source("", "database/structure/bulk_action_modal.twig", "/var/www/doctor.way-interactive-convergence.com/public/phpmyadmin/templates/database/structure/bulk_action_modal.twig");
    }
}
