<?php
/*
 * File name: MedicineOptionGroup.php
...
class MedicineOptionGroup extends Model
{
    use HasTranslations;
    ...
    public $table = 'medicine_option_groups';
    public $fillable = [
        'name',
        'allow_multiple'
    ];
    ...
    {
        return $this->hasMany(MedicineOption::class, 'medicine_option_group_id');
    }
}
