        ...
        <div class="modal-content">
            <div class="modal-header align-items-stretch">
                ...
                <div style="width: 250px;" id="selectCollection" class="ml-auto mr-3">
                    <select name="collection_name" id="collection_name" class="form-control select2"> </select>
                </div>

                <div id="resizeItems" class="ml-auto btn-group">
                    <button type="button" data-size="2" class="btn btn-outline-secondary"><i class="fas fa-th"></i></button>
                    <button type="button" data-size="3" class="btn btn-primary"><i class="fas fa-th-large"></i></button>
                    <button type="button" data-size="4" class="btn btn-outline-secondary"><i class="fas fa-square"></i></button>
                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/support-03/Dev/wic-doctor/resources/views/layouts/media_modal.blade.php ENDPATH**/ ?>